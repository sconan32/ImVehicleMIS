        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseRoleId = table.Column<string>(maxLength: 256, nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    CreateBy = table.Column<string>(maxLength: 256, nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: true),
                    LocalName = table.Column<string>(maxLength: 256, nullable: true),
                    ModificationDate = table.Column<DateTime>(nullable: true),
                    ModifyBy = table.Column<string>(maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateBy = table.Column<string>(maxLength: 512, nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: true),
                    DivisionType = table.Column<int>(nullable: false),
                    Metadata = table.Column<string>(nullable: true),
                    ModificationDate = table.Column<DateTime>(nullable: true),
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddr = table.Column<string>(maxLength: 256, nullable: true),
                    Metadata = table.Column<string>(nullable: true),
                    ModificationDate = table.Column<DateTime>(nullable: true),
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
                    Name = table.Column<string>(maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Company = table.Column<string>(maxLength: 2048, nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    CreateBy = table.Column<string>(maxLength: 256, nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: true),
                    Depart = table.Column<string>(maxLength: 64, nullable: true),
                    ...
                    RealName = table.Column<string>(maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Agent = table.Column<string>(maxLength: 512, nullable: true),
                    AuditExpiredDate = table.Column<DateTime>(nullable: true),
                    Brand = table.Column<string>(maxLength: 64, nullable: true),
                    ...
                    DriverTel = table.Column<string>(maxLength: 64, nullable: true),
                    ...
                    LicenceNumber = table.Column<string>(maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactAddress = table.Column<string>(maxLength: 2048, nullable: true),
                    CreateBy = table.Column<string>(maxLength: 512, nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: true),
                    ExtraImage1Id = table.Column<long>(nullable: true),
                    ExtraImage2Id = table.Column<long>(nullable: true),
                    ...
                    IdCardNumber = table.Column<string>(maxLength: 128, nullable: true),
                    LicenseImageId = table.Column<long>(nullable: true),
                    LicenseIssueDate = table.Column<DateTime>(nullable: true),
                    LicenseNumber = table.Column<string>(maxLength: 128, nullable: true),
                    LicenseType = table.Column<string>(nullable: true),
                    LicenseValidYears = table.Column<int>(nullable: true),
                    LivingAddress = table.Column<string>(maxLength: 2048, nullable: true),
                    Metadata = table.Column<string>(nullable: true),
                    ModificationDate = table.Column<DateTime>(nullable: true),
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
                    Name = table.Column<string>(maxLength: 512, nullable: true),
                    ...
                    Status = table.Column<int>(nullable: false),
                    Tel = table.Column<string>(maxLength: 128, nullable: true),
                    Title = table.Column<string>(maxLength: 32, nullable: true),
                    TownId = table.Column<long>(nullable: true),
                    VersionNumber = table.Column<int>(nullable: false),
                    WarrantyCode = table.Column<string>(maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentFilePath = table.Column<string>(maxLength: 2048, nullable: true),
                    ChiefName = table.Column<string>(maxLength: 32, nullable: true),
                    ChiefTel = table.Column<string>(maxLength: 64, nullable: true),
                    ChiefTitle = table.Column<string>(maxLength: 64, nullable: true),
                    ...
                    License = table.Column<string>(maxLength: 256, nullable: true),
                    LicenseImageId = table.Column<long>(nullable: true),
                    ...
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
                    Name = table.Column<string>(maxLength: 512, nullable: true),
                    PoliceOffice = table.Column<string>(maxLength: 128, nullable: true),
                    Policeman = table.Column<string>(maxLength: 32, nullable: true),
                    RegisterAddress = table.Column<string>(maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ClientPath = table.Column<string>(maxLength: 2048, nullable: true),
                    ContentType = table.Column<string>(maxLength: 512, nullable: true),
                    CreateBy = table.Column<string>(maxLength: 512, nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: true),
                    ...
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
                    Name = table.Column<string>(maxLength: 512, nullable: true),
                    ServerPath = table.Column<string>(maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: true),
                    GroupId = table.Column<long>(nullable: true),
                    IdCardNum = table.Column<string>(maxLength: 128, nullable: true),
                    Metadata = table.Column<string>(nullable: true),
                    ModificationDate = table.Column<DateTime>(nullable: true),
                    ModifyBy = table.Column<string>(maxLength: 512, nullable: true),
                    Name = table.Column<string>(maxLength: 512, nullable: true),
