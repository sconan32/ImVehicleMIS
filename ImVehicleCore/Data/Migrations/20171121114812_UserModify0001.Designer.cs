...
namespace ImVehicleCore.Data.Migrations
{
    ...
    [Migration("20171121114812_UserModify0001")]
    partial class UserModify0001
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImVehicleCore.Data.SecurityItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ImVehicleCore.Data.SecurityItem", b =>
                {
                    b.HasOne("ImVehicleCore.Data.TownItem")
                        .WithMany("SecurityItems")
                        .HasForeignKey("TownItemId");
                });

            modelBuilder.Entity("ImVehicleCore.Data.SecurityPerson", b =>
                {
                    b.HasOne("ImVehicleCore.Data.SecurityItem", "SecurityItem")
