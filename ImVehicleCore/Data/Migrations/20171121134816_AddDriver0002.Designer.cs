...
namespace ImVehicleCore.Data.Migrations
{
    ...
    [Migration("20171121134816_AddDriver0002")]
    partial class AddDriver0002
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImVehicleCore.Data.DriverItem", b =>
                {
                    ...
                    b.Property<string>("PhotoDriverLicensePath");

                    b.Property<string>("PhotoIdCard1Path");

                    b.Property<string>("PhotoIdCard2Path");

                    b.Property<string>("PhotoWarrantyPath");
            ...
            modelBuilder.Entity("ImVehicleCore.Data.GroupItem", b =>
                {
                    ...
                    b.Property<string>("PhotoMainPath");

                    b.Property<string>("PhotoSecurityPath");
            ...
            modelBuilder.Entity("ImVehicleCore.Data.SecurityPerson", b =>
                {
                    ...
                    b.Property<long?>("SecurityItemId");
            ...
            modelBuilder.Entity("ImVehicleCore.Data.VehicleItem", b =>
                {
                    ...
                    b.Property<string>("PhotoDriverPath");

                    b.Property<string>("PhotoFrontPath");

                    b.Property<string>("PhotoRearPath");
            ...
            modelBuilder.Entity("ImVehicleCore.Data.GroupItem", b =>
                {
                    b.HasOne("ImVehicleCore.Data.TownItem")
                        .WithMany("Groups")
                        .HasForeignKey("TownItemId");
                });

            modelBuilder.Entity("ImVehicleCore.Data.SecurityPerson", b =>
                {
                    b.HasOne("ImVehicleCore.Data.GroupItem", "SecurityItem")
                        .WithMany("SecurityPersons")
                        .HasForeignKey("SecurityItemId");
                });
